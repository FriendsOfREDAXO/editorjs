...
` && (t += 1), t;
  ...
  var TextImageBlock = class {
    ...
    constructor({ data, config, api, readOnly }) {
      ...
      this.data = {
        ...
        mediaType: data.mediaType || (data.imageFile ? "image" : ""),
        // 'image' oder 'video'
        ...
        // Lightbox standardmäßig aktiviert
        videoAutoplay: data.videoAutoplay !== void 0 ? data.videoAutoplay : false,
        videoMuted: data.videoMuted !== void 0 ? data.videoMuted : false,
        videoLoop: data.videoLoop !== void 0 ? data.videoLoop : false,
        videoControls: data.videoControls !== void 0 ? data.videoControls : true
      };
      this.layouts = {
        left: {
          title: "Bild links",
    ...
    _createSelectButton() {
      const button = this._make("div", [this.CSS.button], {
        innerHTML: '<i class="fa-solid fa-plus"></i> Bild oder Video aus Medienpool w\xE4hlen'
      });
      button.addEventListener("click", () => {
        this._openMediapool();
      });
  ...
  var ImageGalleryBlock = class {
    ...
    render() {
      ...
      this._renderItems();
      const addButton = this._make("button", [this.CSS.addButton], {
        innerHTML: '<i class="fa-solid fa-plus"></i> Bild hinzuf\xFCgen',
        type: "button"
      });
      addButton.addEventListener("click", () => {
        this._addItem();
    ...
    renderSettings() {
      ...
      const sizeLabel = this._make("div", null, {
        innerHTML: "<strong>Bildgr\xF6\xDFe:</strong>",
    ...
    _createItemElement(item, index) {
      ...
      const altInput = this._make("input", [this.CSS.titleInput], {
        type: "text",
        placeholder: "Alt-Text f\xFCr Barrierefreiheit",
        value: item.alt
      });
    ...
    _createImagePreview(item, index) {
      ...
      imageContainer.title = "Klicken um Bild zu \xE4ndern";
  ...
  var CardBlock = class {
    ...
    renderSettings() {
      ...
      const changeMediaButton = this._make("span", [this.CSS.settingsButton], {
        innerHTML: '<i class="fa-solid fa-image"></i>',
        title: "Media aus Medienpool w\xE4hlen"
      });
    ...
    _createSelectButton() {
      const button = this._make("div", [this.CSS.button], {
        innerHTML: '<i class="fa-solid fa-plus"></i> Media aus Medienpool w\xE4hlen'
      });
      button.addEventListener("click", () => {
        this._openMediapool();
      });
  ...
  window.EditorJSUtils = {
    ...
    getAvailableTools: function() {
      ...
      if (typeof window.CardBlock !== "undefined") {
        tools.card = {
