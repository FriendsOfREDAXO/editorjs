...
` && (t += 1), t;
  ...
  var rexmedia_default = REXMediaTool2;
  ...
  var VideoBlock = class {
    ...
    constructor({ data, config, api, readOnly }) {
      ...
      this.readOnly = readOnly;
      this.config = config || {};
      this.mediaTool = new rexmedia_default({
        api: this.api,
        config: {
          types: ["mp4", "webm", "ogv"],
          // Video files
      ...
      this.posterTool = new rexmedia_default({
        api: this.api,
        config: {
          types: ["jpg", "jpeg", "png", "gif", "svg", "webp"],
          // Image files
      ...
      this.subtitleTool = new rexmedia_default({
        api: this.api,
        config: {
          types: ["vtt"],
          // VTT subtitle files
      ...
      this.data = {
        ...
        controls: data.controls === void 0 ? true : data.controls,
        aspectRatio: data.aspectRatio || "auto"
      };
      this.aspectRatios = {
        "auto": { title: "Automatisch", icon: '<i class="fa-solid fa-expand-arrows-alt"></i>' },
    ...
    renderSettings() {
      ...
      const changeVideoButton = this._createSettingButton("video", "Video \xE4ndern", () => this._openMediapool("video"));
      ...
      const aspectRatioDropdown = this._createDropdown("Seitenverh\xE4ltnis", "crop-simple", this.aspectRatios, this.data.aspectRatio, (value) => this._setAspectRatio(value));
    ...
    _createSelectButton() {
      const button = this._make("div", [this.CSS.button], {
        innerHTML: '<i class="fa-solid fa-video"></i> Video aus Medienpool w\xE4hlen'
      });
    ...
    _createDropdown(label, icon, options, currentValue, onChange) {
      ...
      const button = this._make("span", [this.CSS.settingsButton, "cdx-video-dropdown__button"], {
        innerHTML: `<i class="fa-solid fa-${icon}"></i> ` + (options[currentValue]?.title || "W\xE4hlen"),
        title: label
      });
  ...
  var Hero = class {
    ...
    constructor({ data, config, api, readOnly }) {
      ...
      this.data = {
        ...
        subtitle: data.subtitle || "Ein aussagekr\xE4ftiger Untertitel",
        text: data.text || "Beschreibender Text f\xFCr Ihren Hero-Bereich. Hier k\xF6nnen Sie Ihre wichtigste Botschaft vermitteln.",
            ...
            <div class="${this.CSS.imageUpload}">
                ...
                ` : `
                    <div class="cdx-hero__upload-placeholder">
                        ...
                        <p>Hintergrundbild hinzuf\xFCgen</p>
                        <small>Aus dem REDAXO Medienpool ausw\xE4hlen</small>
                    </div>
                `}
            </div>
        `;
    ...
    _editButtonUrl(buttonType) {
      ...
      const newUrl = prompt(`URL f\xFCr ${buttonType === "primary" ? "prim\xE4ren" : "sekund\xE4ren"} Button:`, currentUrl);
      if (newUrl !== null) {
  ...
  window.Marker = s2;
  window.LinkTool = I3;
  window.REXLinkTool = RexLink;
  window.AlertBlock = Alert;
  window.TextImageBlock = TextImage;
